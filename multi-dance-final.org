...
**** Rule 11 Values:
   #+BEGIN_SRC emacs-lisp
     (setq rule-11-dance-rows (rule-11-rows '(112 116) final-dance)
           ...
           dance-totals-columns (create-dance-columns totals '(112 116))
           dance-totals-rows (transpose final-totals-columns))
   #+END_SRC

   #+RESULTS:
   | 112 | 1 | 1 | 4 |  9 | 13 | 20 | 20 |
   | 116 | 1 | 1 | 4 | 10 | 16 | 20 | 20 |
