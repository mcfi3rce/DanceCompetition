...
#+RESULTS:
| (1 0 0 0 0 0 0 5) | (112 0 0 1 3 3 5 5) | (113 1 2 3 3 5 5 5) | (114 1 1 3 4 5 5 5) | ((0 0 2 1 5 1 1) 2 5 5 5 5 5 5) | (116 1 1 2 3 4 5 5) | (117 0 1 1 2 3 5 5) |
|                 1 |                 112 |                 113 |                 114 | (0 0 2 1 5 1 1)                 |                 116 |                 117 |
...
#+BEGIN_SRC emacs-lisp :results silent
  (defun calculate-placement (totals)
    (loop with majority-num = 0
          ...
          if (= (length (find-number-of-majorities place)) 1)
