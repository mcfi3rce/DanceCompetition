        ...
        (t (setq tied-majorities (find-couples-with-largest-majority number-majorities))
           (case (length tied-majorities)
             ...
             (t (setq couple-sums (compare-n-sums tied-majorities place-val)
                      ...
                      remaining-couples (remove (assoc (car winning-couple) couple-sums) couple-sums))
                ...
                (case (length winning-couple)
                  (1
                   ...
                   (remove-couples couple-sums)
                   ;(if (test-for-tie remaining-couples)
                       ;(really-tied (find-winning-couples remaining-couples) place couples-list)
                                          ;(remove-couples tied-majorities)))
                   )
